...
__Learning Lab 70: Introduction to NLP.__
...
```{r}
output$resume_image <- renderImage({
...
shiny::imageOutput("resume_image")
```
...
observe({
  ...
  if (is.null(input$job_file)) {
    ...
    # OCR
    job_text <- tesseract::ocr(job_image)
...
wordcloud2::wordcloud2Output("word_cloud_2")
```

#### Job Description

```{r}
output$word_cloud_job_2 <- renderWordcloud2({
...
wordcloud2::wordcloud2Output("word_cloud_job_2")
```
